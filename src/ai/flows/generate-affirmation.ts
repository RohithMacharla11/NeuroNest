...
/**
 * @fileOverview Generates a daily affirmation based on the user's mood.
 *
 * - generateAffirmation - A function that generates a daily affirmation.
...
const GenerateAffirmationInputSchema = z.object({
  mood: z
    .string()
    .describe("The user's current mood."),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an AI assistant designed to provide daily affirmations.

  Based on the user's current mood, generate a short, positive, and encouraging affirmation.
